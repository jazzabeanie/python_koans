...
class AboutTrueAndFalse(Koan):
    ...
    def test_empty_collections_are_treated_as_false(self):
        self.assertEqual('false stuff', self.truth_value([])) #list
        self.assertEqual('false stuff', self.truth_value(())) #tuple
        self.assertEqual('false stuff', self.truth_value({})) #dictionary?
        self.assertEqual('false stuff', self.truth_value(set())) #what does set() do?
